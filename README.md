...
Open the fine-tuning MedGemma notebook posted here on Google Colab with the following link: https://colab.research.google.com/github/EddyferO/Smart-Glass-Medical-Assistant/blob/main/notebooks/fine_tune_medgemma.ipynb.
